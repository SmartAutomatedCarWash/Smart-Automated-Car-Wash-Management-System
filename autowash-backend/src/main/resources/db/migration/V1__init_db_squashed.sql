...
-- FK references now that bookings table exists
ALTER TABLE user_discounts ADD CONSTRAINT fk_user_discounts_booking FOREIGN KEY (used_in_booking_id) REFERENCES bookings(id);
ALTER TABLE customer_combo_usages ADD CONSTRAINT fk_customer_combo_usages_booking FOREIGN KEY (booking_id) REFERENCES bookings(id);
ALTER TABLE point_transactions ADD CONSTRAINT fk_point_transactions_booking FOREIGN KEY (booking_id) REFERENCES bookings(id);
...
ADD CONSTRAINT chk_subtotal_matches
CHECK (subtotal = snapshot_price * quantity);
...
ADD CONSTRAINT chk_final_amount_matches
CHECK (final_amount = subtotal - discount_amount);

ALTER TABLE booking_pricing
ADD CONSTRAINT chk_discount_consistency
CHECK (
