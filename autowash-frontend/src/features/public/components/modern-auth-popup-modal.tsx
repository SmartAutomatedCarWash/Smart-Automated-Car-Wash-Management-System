...
export function ModernAuthPopupModal({
  ...
  return createPortal(
    ...
    >
      <div
        className="relative my-auto flex max-h-[calc(100vh-2rem)] w-full overflow-hidden border border-white/20 bg-white shadow-2xl dark:bg-[#071016] animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-500 ease-out"
        style={{
